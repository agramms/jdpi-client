...
class TestTokenStorageRedis < Minitest::Test
  def setup
    ...
    Redis.define_singleton_method(:new) { |*_args| mock_redis_instance }
  ...
  def test_healthy_returns_false_on_connection_error
    ...
    Redis.define_singleton_method(:new) { |*_args| raise Redis::CannotConnectError }
  ...
  def teardown
    ...
    return unless Redis.singleton_class.method_defined?(:new) && Redis.method(:new).owner == Redis.singleton_class
